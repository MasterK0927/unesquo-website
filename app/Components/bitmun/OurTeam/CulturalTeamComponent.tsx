...
interface CulturalTeamProps {
  culturalTeamData: Team[];
}
...
const CulturalTeamComponent: React.FC<CulturalTeamProps> = ({ culturalTeamData }) => {
  return (
    <>
      <h1 className={styles['heading']}>CULTURAL</h1>
      <div className={styles.teamGrid}>
        <div className={styles.teamCards}>
          {culturalTeamData.map((team) => (
...
export default CulturalTeamComponent;