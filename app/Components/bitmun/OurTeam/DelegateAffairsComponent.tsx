...
interface DelegateAffairsTeamProps {
  delegateAffairsData: Team[];
}
...
const DelegateAffairsTeamComponent: React.FC<DelegateAffairsTeamProps> = ({ delegateAffairsData }) => {
  return (
    <>
      <h1 className={styles['heading']}>DELEGATE AFFAIRS</h1>
      <div className={styles.teamGrid}>
        <div className={styles.teamCards}>
          {delegateAffairsData.map((team) => (
...
export default DelegateAffairsTeamComponent;