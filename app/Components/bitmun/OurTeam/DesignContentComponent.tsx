...
interface DesignContnetProps {
  designContentData: Team[];
}
...
const DesignContentComponent: React.FC<DesignContnetProps> = ({ designContentData }) => {
  return (
    <>
      <h1 className={styles['heading']}>DESIGN AND CONTENT</h1>
      <div className={styles.teamGrid}>
        <div className={styles.teamCards}>
          {designContentData.map((team) => (
...
export default DesignContentComponent;