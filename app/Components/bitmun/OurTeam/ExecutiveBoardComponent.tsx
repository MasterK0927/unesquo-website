...
const ExecutiveBoardComponent: React.FC<ExecutiveBoardProps> = ({ executiveBoardData }) => {
  return (
    <>
      <h1 className={styles['heading']}>EXECUTIVE BOARD AFFAIRS</h1>
      <div className={styles.teamGrid}>
        <div className={styles.teamCards}>
          {executiveBoardData.map((team) => (
...
export default ExecutiveBoardComponent;