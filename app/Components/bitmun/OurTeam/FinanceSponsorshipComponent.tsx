...
interface FinanceSponsorshipProps {
  financeSponsorshipData: Team[];
}
...
const FinanceSponsorshipComponent: React.FC<FinanceSponsorshipProps> = ({ financeSponsorshipData }) => {
  return (
    <>
      <h1 className={styles['heading']}>FINANCE AND SPONSORSHIP</h1>
      <div className={styles.teamGrid}>
        <div className={styles.teamCards}>
          {financeSponsorshipData.map((team) => (
...
export default FinanceSponsorshipComponent;