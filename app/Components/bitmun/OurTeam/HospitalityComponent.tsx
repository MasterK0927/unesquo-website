...
const HospitalityComponent: React.FC<HospitalityProps> = ({ hospitalityData }) => {
  return (
    <>
      <h1 className={styles['heading']}>HOSPITALITY</h1>
      <div className={styles.teamGrid}>
        <div className={styles.teamCards}>
          {hospitalityData.map((team) => (
