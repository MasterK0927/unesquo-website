...
const ItineraryList1: React.FC<ItineraryListProps> = ({ itineraryData }) => {
  return (
    <div style={timelineContainerStyle}>
      ...
      <div style={itineraryListStyle}>
        <div style={itineraryItemStyle}>
          <span style={timeStyle}>{itineraryData[0].time}</span>
          <span style={activityStyle}>{itineraryData[0].activity}</span>
        </div>
      </div>
      ...
      <div style={itineraryListStyle1}>
        <div style={itineraryItemStyle}>
          <span style={timeStyle}>{itineraryData[1].time}</span>
          <span style={activityStyle}>{itineraryData[1].activity}</span>
        </div>
      </div>
      ...
      <div style={itineraryListStyle2}>
        <div style={itineraryItemStyle}>
          <span style={timeStyle}>{itineraryData[2].time}</span>
          <span style={activityStyle}>{itineraryData[2].activity}</span>
        </div>
      </div>
      ...
      <div style={itineraryListStyle3}>
        <div style={itineraryItemStyle}>
          <span style={timeStyle}>{itineraryData[3].time}</span>
          <span style={activityStyle}>{itineraryData[3].activity}</span>
        </div>
      </div>
      ...
      <div style={itineraryListStyle4}>
        <div style={itineraryItemStyle}>
          <span style={timeStyle}>{itineraryData[4].time}</span>
          <span style={activityStyle}>{itineraryData[4].activity}</span>
        </div>
      </div>
    </div>
  );
