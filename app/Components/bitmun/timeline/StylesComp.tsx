...
export const CardContainer = styled.div<CardContainerProps>`
  ...
  position: absolute;
  display: flex;
  opacity: ${({ verPos }) => (verPos && verPos >= 51 ? 0 : verPos && verPos < 0 ? 0 : 1)};
  flex-direction: column;
...
export const Mark = styled.div<MarkProps>`
  left: var(--timeline);
  opacity: ${({ verPos }) => (verPos && verPos >= 49 ? 0 : verPos && verPos < 0 ? 0 : 1)};
  position: absolute;
  width: 0.6em;
  height: 0.6em;
  border-radius: 50%;
  border: 1.5px solid white;
  box-shadow: 0.3em 0.3em 0.5em #fb8e8e inset, -0.3em -0.3em 0.3em red inset, -0.3em -0.3em 0.5em #fff,
