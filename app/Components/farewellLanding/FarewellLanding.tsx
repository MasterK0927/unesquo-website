...
import amanBhaiya from '../../../public/images/aman.jpeg';
import kaushikBhaiya from '../../../public/images/farewell/kaushikBhaiya.png';
import sarahDi from '../../../public/images/farewell/sarahDi.jpg';
import akashbhaiya from '../../../public/images/akash.jpeg';
import ohmbhaiya from '../../../public/images/ohm.jpeg';
...
const initialImages: Person[] = [
  {src: akashbhaiya, name: 'Akash Rupam Ekka', slug: 'Charisma Chief', skills: ['Grand Leader', 'Sydney Swiftie'], description: "Farewell, Akash Bhaiya! Your eloquence, rivaling even Dumbledore, left us in awe. Like Master Oogway to our Po, your doors were always open for us. There was something about you that drew us in—whether it was your music taste, your poetry, your Zen-like wisdom, or your unique cinematic preferences that made you the Quentin Tarantino of our crew. You consistently defied expectations everywhere. Listing all your contributions to the club would be like Spurs and Kane winning a trophy: nearly impossible. For these past years, you have always been there for us, and now, you won't be. We'll miss you more than Thor missed his Mjölnir. But, as always, the wheel turns as it wills. Au revoir, Akash Rupam Ekka. May the force be with you."},
  {src: ohmbhaiya, name: 'Ohm Gupta', slug: 'OG Sponsor', skills: ['Corporate Savvy', 'MUN Maestro'], description: "Farewell, Ohm Bhaiya! You were a born diplomat, with the grace of a seasoned public speaker and the elegance of a natural leader. Your well-spoken words commanded attention, just like your leadership of BITMUN, your brainchild.  We'll miss your insights during our recreational breaks, but most of all, your presence that elevated every conversation.  As you step into the corporate world, know that UNESQUO won't be the same without you.  Thank you for everything that UNESQUO could accomplish and hopes to, Ohm Bhaiya. We'll miss you dearly."},
